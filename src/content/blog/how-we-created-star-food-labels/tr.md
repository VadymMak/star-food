...
## Avrupa gıda ticaretinde etiket tasarımı neden önemlidir?

Star Food markasını başlattığımızda ilk içgüdümüz ürüne odaklanmaktı — tedarik, kalite, lojistik. Etiket tasarımı ikincil geliyordu. İstanbul'daki bir distribütör CoA ve fiyatla ilgilenecek, şişenin grafik tasarımıyla değil.
...
| --------------------------- | ----------------------------- | --------------------------------- |
| Gıdanın adı                 | Net ve doğru                  | Tüm 5 dilde "Rafine Ayçiçek Yağı" |
| Net miktar                  | Sıvılar için litre/ml         | Ön panelde belirgin yerleşim      |
| Minimum dayanıklılık tarihi | Net tarih formatı             | Arka panelde lazer baskı          |
| Saklama talimatları         | Sıcaklık koşulları            | Arka panel, besin tablosunun altı |
| Sorumlu operatör            | İsim + adres                  | Arka panel, alt bölüm             |
| Menşe ülke                  | Bitkisel yağlar için zorunlu  | "Bulgaristan/Ukrayna Ürünü"       |
